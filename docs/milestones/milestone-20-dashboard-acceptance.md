...
Decision 280 accepts the chart-first Results direction, but the detailed
specification, implementation, deployment, tests, renewed owner acceptance,
and objective technical gates are not yet complete.
