...
|---|---|---|---|---|---|---|---|
| Repository and environment | WSL clone, Python 3.12, VectorBT Pro, Git hygiene and tests exist | Automated environment health summary and visible dependency/version status | Required | None | Clean clone/environment can run fixture workflow and report versions | System status page | Codex |
