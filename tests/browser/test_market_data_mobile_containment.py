...
def _horizontal_overflow_nodes(page) -> list[dict[str, object]]:
    return page.locator("#route-research-market-data *").evaluate_all(
        """
        (elements) => {
...
def test_long_market_data_path_stays_contained_at_mobile_width(
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            overflow_nodes = _horizontal_overflow_nodes(page)
