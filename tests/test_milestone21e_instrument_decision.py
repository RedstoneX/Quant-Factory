...
def test_milestone21e_selects_schx_without_promoting_profitability() -> None:
    ...
    assert "SCHX is the broad-market whole-share execution fixture" in decisions
...
def test_spym_remains_fixture_not_final_forward_test_instrument() -> None:
    ...
    assert "SPYM remains an ingestion and deterministic research fixture" in decisions
...
def test_milestone21_and_22_are_complete_and_milestone23_is_active() -> None:
    ...
    assert (
        ...
        "dashboard foundation, equity fixture, and unified validation | Durable "
        "records, reproducible evidence, normalized outcomes, and protected-data "
        "gates | Complete |"
        in normalized_milestones
    )
